...
namespace BreathLib.SerializableInterface
{
    internal abstract class ReferenceDrawer
    {
		...
		protected bool excludesUnityObjects { get; private set; }
        ...
        protected void Initialize(SerializedProperty property, Type genericType, FieldInfo fieldInfo, bool excludesUnityObjects)
        {
            Property = property;
        ...
        private void OnButtonClicked(Rect position, SerializedProperty property)
        {
            ...
            SerializableInterfaceAdvancedDropdown dropdown =
                new SerializableInterfaceAdvancedDropdown(state, GenericType, GetRelevantScene(property), property, excludesUnityObjects);
